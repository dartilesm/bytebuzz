  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&>div]:relative [&>div]:overflow-hidden [&>div]:block!"
      >
        {/* Start Sentinel */}
        <div
