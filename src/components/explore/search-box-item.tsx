          ...
          <div className='flex flex-col gap-0.5 flex-1 min-w-0'>
            ...
            <div className='flex items-center gap-3 text-xs text-muted-foreground'>
              <span className="flex items-center gap-1">
                <span className="font-medium text-foreground">{userData?.follower_count ?? 0}</span> followers
              </span>
              <span className="flex items-center gap-1">
                <span className="font-medium text-foreground">{userData?.following_count ?? 0}</span> following
              </span>
            </div>
          </div>
        </div>
